...
SVG =
  facebook: (color, size) -> """
    <svg style="display: inline-block; width: #{ size }; height: #{ size }" xmlns="http://www.w3.org/2000/svg" class="facebook-icon" fill="white" viewBox="10 10 40 40" role="img">
  ...
  twitter: (color, size) -> """
    <svg style="display: inline-block; width: #{ size }; height: #{ size }" xmlns="http://www.w3.org/2000/svg" class="twitter-icon" viewBox="10 10 40 40" role="img">
